...
np.savetxt("datasets//predictions//Inceptionv3_"+ver+"_predictions.csv", pred, fmt='%1.18f', delimiter=',')
...
plt.savefig("datasets//predictions//Inceptionv3_"+ver+"_val_graph.png", dpi=150)
plt.show()
